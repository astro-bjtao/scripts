...
PROPS_ORIGINAL_BMODEL     = f"{PROPS_ORIGINAL}/bmodel/"
PROPS_ORIGINAL_BMODEL_VAR = f"{PROPS_ORIGINAL}/bmodel_var/"
PROPS_ORIGINAL_CLEAN_IMAGE   = f"{PROPS_ORIGINAL}/clean_image/"
PROPS_ORIGINAL_CLEAN_VAR     = f"{PROPS_ORIGINAL}/clean_var/"
PROPS_ORIGINAL_CLEAN_ISO     = f"{PROPS_ORIGINAL_CLEAN_IMAGE}/iso_table/"
PROPS_ORIGINAL_CLEAN_VAR_ISO = f"{PROPS_ORIGINAL_CLEAN_VAR}/iso_table/"
PROPS_ORIGINAL_COG           = f"{PROPS_ORIGINAL_CLEAN_IMAGE}/isotab_cog/"
PROPS_ORIGINAL_VAR_TOTAL     = f"{PROPS_ORIGINAL_CLEAN_VAR}/isotab_totvar/"